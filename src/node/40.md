...
\n(<span class="caps">IZQUIERDA</span>: se ve la diapositiva del primer libro m&eacute;dico. <span class="caps">DERECHA</span>: en blanco)\n
...
\n(<span class="caps">IZQUIERDA</span>: en blanco. <span class="caps">DERECHA</span>: diapositiva de <span class="caps">ISNA</span>)\n
...
\n(<span class="caps">IZQUIERDA</span>: diapositiva m&eacute;dica, similar a la anterior) <span class="caps">DERECHA</span>: en blanco)\n
...
\n(<span class="caps">IZQUIERDA</span>: en blanco. <span class="caps">DERECHA</span>: Howard Devore y su perro.)\n
...
\n(<span class="caps">IZQUIERDA</span>: diapositiva m&eacute;dica, similar. <span class="caps">DERECHA</span>: en blanco)\n

\nMiren de nuevo. As&iacute; es c&oacute;mo los m&eacute;dicos nos representan.\n

\n(<span class="caps">IZQUIERDA</span>: en blanco. <span class="caps">DERECHA</span>: Cheryl Chase y un caballo)\n
...
\n(<span class="caps">IZQUIERDA</span>: en blanco. <span class="caps">DERECHA</span>: Diane Anger)\n
...
\n(<span class="caps">IZQUIERDA</span>: diapositiva m&eacute;dica.DERECHA: en blanco)\n
...
\n(<span class="caps">IZQUIERDA</span>: en blanco. <span class="caps">DERECHA</span>: Max Beck)\n
...
\n(<span class="caps">IZQUIERDA</span>: diapositiva m&eacute;dica. <span class="caps">DERECHA</span>: en blanco)\n

\nEsto es un monstruo patol&oacute;gico.\n

\n(<span class="caps">IZQUIERDA</span>: en blanco. <span class="caps">DERECHA</span>: grupo de manifestantes con pancartas donde se lee "Hermafroditas con car&aacute;cter").\n
...
\nLos doctores ense&ntilde;an a los padres a mentir a sus parientes, vecinos y a sus ni&ntilde;os y ni&ntilde;as intersex. Confrontados con genitales ambiguos <del>genitales que tienen una apariencia entre masculina y femenina</del> la pol&iacute;tica m&eacute;dica es "Cuando dudes, c&oacute;rtalo". Esto es, si un ni&ntilde;o nace con un cl&iacute;toris m&aacute;s largo que 3/8 pulgadas, los doctores lo quitan. Si un ni&ntilde;o nace con un pene m&aacute;s peque&ntilde;o que una pulgada, los doctores quitan su pene y test&iacute;culos, y marcan el resultado como una ni&ntilde;a, bajo la teor&iacute;a de que, si se cortan las partes suficientes de un ni&ntilde;o, lo que queda es una ni&ntilde;a.\n
...
\nLa Suprema Corte de Colombia, en Sud Am&eacute;rica, esta en este momento considerando si las cirug&iacute;as de cl&iacute;toris sobre ni&ntilde;os y ni&ntilde;as intersex son o no violaciones de principios fundamentales de derechos humanos. Sus carpetas contienen el abstract de una carta que la <span class="caps">ISNA</span> present&oacute; ante la Corte.\n
